        ...
        <div>
            <div className="hero w-96 h-96 container md:mx-auto lg:mx-auto md:w-[600px] lg:w-[1100px] lg:h-72 md:h-[250px] rounded-3xl mb-10" style={{ backgroundImage: 'url(https://i.ibb.co/tzKD0pv/pexels-pixabay-261169.jpg)' }}>
                ...
                <div className="hero-content text-center text-neutral-content">
                    <div className="max-w-md">
                        <h1 className="mb-5 text-white text-5xl font-bold animate__animated  animate__backInDown">Spot Details</h1>
            ...
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content flex-col lg:flex-row">
                    ...
                    <div>
                        <h1 className="animate__animated  animate__flip text-5xl font-bold">{spots.name}</h1>
                        <h2 className="text-2xl text-black mt-2  font-bold">Location: <span className="text-2xl text-blue-500 mt-2  font-bold">{}</span></h2>
                        <p className="py-2 text-xl font-medium">{}</p>
{/* 
                        ...
                        <div className="flex gap-x-10 font-semibold text-xl">
                            <p className="border-2 rounded-md border-blue-400">{}</p>
                            <p className="border-2 rounded-md border-blue-400">{}</p>
                            <p>For: <span className="border-2 rounded-md border-blue-400">{}</span></p>
